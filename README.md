...
### אם אתה פועל שלא למטרות רווח, אל תהסס ליצור איתנו קשר, ניתן לך אישור בשמחה!

בקשת יצירת הקשר היא בקשה טכנית בלבד,
ונועדה כדי שנוכל להעביר לך מספר הוראות פשוטות, ולתאם איתך כמה דברים.

רשימת האתרים / ארגונים וכדו' שקבלו מאיתנו אישור:
 - [זית](https://zayitapp.com/)
 - [ארון הספרים הדיגיטלי](https://hebrewbooks-2026.github.io/)
...
#### ים החכמה (yam-HaHachma) - תיקיית `yam-HaHachmaToOtzaria`

<img src="yam-HaHachmaToOtzaria/logo.png" alt="ים החכמה" width="120" />

**טקסטים:** כפופים לרישיון מאגר "ים החכמה" — שימוש אישי בלבד; העתקה למאגרים תורניים
**חינמיים** מותרת ללא רשות מראש, בכפוף לקרדיט ולתנאים שלהלן  
**סקריפטים ועיבודים שלנו:** Personal Use License 1.0 (שימוש אישי בלבד)

[מאגר הספרים התורני "ים החכמה"](https://github.com/torahtyh/yam-HaHachma)  
[נוסח הרישיון המלא](yam-HaHachmaToOtzaria/LICENSE-yam-HaHachma.md)

**קרדיט:** הספרים שבתיקייה זו נלקחו ממאגר **["ים החכמה"](https://github.com/torahtyh/yam-HaHachma)**.

**תנאי ההעתקה שלהם, ואיך אנחנו עומדים בהם:**

* **קרדיט** — מצוין בכל מקום שמוצג בו מקור הספר שמקורו במאגר "ים החכמה", בצירוף
  קישור. הרישיון שלהם מוסיף במפורש: "אין צורך להוסיף את הקרדיט בתוך גוף הספר
  עצמו" — ולכן אין באנר קרדיט בגוף הספר, בשונה ממקורות אחרים.
* **שם המאגר והלוגו** — מוצגים כאן, וכן במסך "אודות הספר" ובהגדרות→אודות
  באפליקציית אוצריא, עם קישור למאגר.
* **היקף ההעתקה** — התנאי שלהם הוא שמאגר המעתיק יעתיק את **כל** ספרי "ים החכמה"
  ולא יברור מתוכם, למעט ספרים שכבר קיימים אצלו או כפילויות. העתקנו את כולם.
* **שיתוף תיקונים והערות** — דיווחי שגיאה על ספרים מתיקייה זו נשלחים גם אלינו וגם
  אל מאגר "ים החכמה" (y025837086@gmail.com).
